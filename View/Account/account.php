					...
					<div class="box_account">
						...
						<div class="form_container">
							...
							<form action="index.php?act=account" onsubmit="return sendDangnhap()" method="post">
								...
								<div class="text-center"><input type="submit" name="login" value="Đăng nhập " class="btn_1 full-width"></div>
								<div id="forgot_pw">
									<div class="form-group">
					...
					<div class="box_account">
						...
						<form action="index.php?act=account" onsubmit="return sendDangky()" method="post">
							<div class="form_container">
								...
								<div class="form-group">
									<input type="password" class="form-control password" name="password" id="password_in_2" value="" placeholder="Mật khẩu *">
								</div>
								<div class="err__login">
								...
								<div class="private box">
									<div class="row no-gutters">
										...
										<div class="col-6 pl-1">
											<div class="form-group">
												<input type="number" class="form-control phone" name="phone" placeholder="Số điện thoại *">
											</div>
											<div class="err__login">
										...
										<div class="col-12">
											<div class="form-group">
												<input type="text" class="form-control address" name="address" placeholder="Địa chỉ *">
											</div>
											<div class="err__login">
								...
								<div class="text-center"><input type="submit" value="Đăng kí " name="signup" class="btn_1 full-width"></div>
							</div>
						</form>
						<!-- /form_container -->
					</div>
